...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('discord_user_snowflake', models.BigIntegerField(help_text='the Discord snowflake of the user discipline by this instance', verbose_name='Discord User Snowflake')),
                ...
                ('moderator_user_snowflake', models.BigIntegerField(verbose_name='')),
